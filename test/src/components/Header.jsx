  ...
  return (
    <header className='bg-black text-text-c h-screen w-full flex flex-col items-center justify-center snap-start font-display'>
        <div>
          ...
          <a className="bg-accent-c text-text-c inline-block no-underline mt-2 pt-2 pr-5 pb-2 pl-5 border-2 rounded-3xl border-accent-c border-solid" href="https://github.com/TitanProgrammer4480" target="_blank">Github</a>
        </div>
    </header>
  )
}